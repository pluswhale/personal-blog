      ...
      <div className="space-y-12">
        ...
        <section className="space-y-4">
          ...
          <p className="text-xl text-gray-600 dark:text-gray-400">
            Full-stack developer, writer, and open-source enthusiast
          </p>
        </section>
        ...
        <section className="space-y-4">
          ...
          <div className="prose dark:prose-invert max-w-none">
            <p className="text-gray-600 dark:text-gray-400 leading-relaxed">
              ...
              through writing. When I'm not coding, you can find me exploring new technologies,
              contributing to open-source projects, or writing about my experiences.
            </p>
            <p className="text-gray-600 dark:text-gray-400 leading-relaxed">
              I specialize in TypeScript, React, Next.js, and Node.js. I'm always excited
              to learn new things and collaborate with other developers on interesting projects.
            </p>
          </div>
        </section>
